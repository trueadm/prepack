...
export class Realm {
  constructor(opts: RealmOptions, statistics: RealmStatistics) {
    ...
    this.react = {
      ...
      originalFuncToClonedFunc: new Map(),
      outlinedFunctionAstNodes: new Set(),
      outlinedFunctionInformation: new Map(),
      outlinedTemporalAbstract: new Map(),
  ...
  react: {
    ...
    originalFuncToClonedFunc: Map<ECMAScriptSourceFunctionValue, ECMAScriptSourceFunctionValue>,
    outlinedFunctionAstNodes: Set<BabelNode>,
    outlinedFunctionInformation: Map<ECMAScriptSourceFunctionValue, Set<Value>>,
    outlinedTemporalAbstract: Map<string, AbstractValue>,
    ...
    reactValueArrays: WeakSet<ObjectValue>,

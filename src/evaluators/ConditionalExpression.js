...
export default function(
  ...
  let conditional = realm.evaluateWithAbstractConditional(
    exprValue,
  ...
  if (conditional instanceof AbstractValue && conditional.kind === "conditional") {
    conditional.astNode = ast;
    exprValue.astNode = ast.test;
  }
  return conditional;
}

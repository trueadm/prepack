...
import { createRenderValuesFromOutlinedFunctionMarker } from "./outlining.js";
...
export class Reconciler {
  ...
  _resolveAbstractValue(
    ...
    if (value.kind === "outlined function marker") {
      let renderValue = createRenderValuesFromOutlinedFunctionMarker(this.realm, value);
      if (renderValue === value) {
        return value;
      }
      return this._resolveDeeply(componentType, renderValue, context, branchStatus, evaluatedNode);
